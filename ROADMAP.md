...
- 🟡 Tower Defense deep factory: visual enemy/tower catalogs, authored waves, pure first/last/strongest/weakest/nearest targeting, visual placement/bounds rules, range/damage combat resolution, pure enemy path progression, and a deterministic wave simulator are generated now. Projectiles, visual path authoring, upgrades, effects, replication, procedural waves, and the 100-wave dashboard remain.
