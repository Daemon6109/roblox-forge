...
- 🟡 Inspector/properties editor, graph drag/drop, session undo/redo, a Forge command palette, and deterministic graph auto-layout are shipped. Durable history/snapshots, breadcrumbs, and deeper search/refactor coverage remain.
