...
- 🟡 Tower Defense deep factory: visual enemy/tower catalogs, authored waves, pure first/last/strongest/weakest/nearest targeting, and a deterministic wave simulator are generated now. Projectiles, path progress, placement, upgrades, effects, replication, procedural waves, and the 100-wave dashboard remain.
